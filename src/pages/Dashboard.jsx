  ...
  return (
    <div className='mt-12'>
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-cover shadow">
        ...
        <div className="flex m-3 flex-wrap justify-center gap-4 items-center">
          {relatorios.map((item) => (
            <div 
              key={item.title} 
              className={`bg-white h-44 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl shadow ${item.bgColor}`}
            >
              <button
                type="button"
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
          <div className="flex justify-between">
            <p className="font-semibold text-xl">Resumo mensal</p>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className="border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  <span className='text-3xl font-semibold'>R$ 95.000,00</span>
                  <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-400 ml-3 text-xs'>23%</span>
                </p>
                <p className='text-gray-500 mt-1'>Saldo</p>
              </div>
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>R$ 45.000,00</span>
                </p>
